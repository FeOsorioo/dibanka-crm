...
use App\Http\Resources\Affiliate\AffiliateConsultationResource;
use App\Http\Requests\Affiliate\AffiliateConsultationRequest;

class AffiliateConsultationController extends Controller
{
    /**
    ...
    {
        $query = AffiliateConsultation::with(['payrolls']);
        ...
        $countActives = AffiliateConsultation::where('is_active', true)->count();
        $countInactives = AffiliateConsultation::where('is_active', false)->count();
        ...
        return response()->json([
            ...
            'consultations' => AffiliateConsultationResource::collection($consultations),
            'pagination'    => [
    ...
    {
        $query = AffiliateConsultation::active()->with(['payrolls']);
     ...
     */
    public function store(AffiliateConsultationRequest $request)
    {
        $consultation = AffiliateConsultation::create($request->validated());
        ...
        return response()->json([
            ...
            'consultation' => new AffiliateConsultationResource($consultation)
    ...
    {
        $query = AffiliateConsultation::query();
        if (method_exists(new AffiliateConsultation, 'specifics')) {
     ...
     */
    public function update(AffiliateConsultationRequest $request, $id)
    {
        $consultation = AffiliateConsultation::findOrFail($id);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if ($newState === 0) {
            ...
            AffiliateSpecific::where('consultation_id', $consultation->id)
                ->update(['is_active' => 0]);
        }
    ...
    {
        $count = AffiliateConsultation::where('is_active', 1)->count();
