...
use App\Http\Resources\Affiliate\AffiliateSpecificResource;
use App\Http\Requests\Affiliate\AffiliateSpecificRequest;

class AffiliateSpecificController extends Controller
{
    /**
    ...
    {
        $query = AffiliateSpecific::with(['consultation.payrolls']);
        ...
        $countActives = AffiliateSpecific::where('is_active', true)->count();
        $countInactives = AffiliateSpecific::where('is_active', false)->count();

        return response()->json([
            'message'       => 'Consultas específicas obtenidas con éxito',
            'specifics' => AffiliateSpecificResource::collection($specifics),
            'pagination'    => [
    ...
    public function active(Request $request)
    {
        ...
        return response()->json([
            ...
            'consultationspecific' => AffiliateSpecificResource::collection($consultations)
        ], Response::HTTP_OK);
    }
     ...
     */
    public function store(AffiliateSpecificRequest $request)
    {

        $specific = AffiliateSpecific::create($request->all());
        ...
        return response()->json([
            ...
            'specific' => new AffiliateSpecificResource($specific)
    ...
    {
        $specific = AffiliateSpecific::find($id);
     ...
     */
    public function update(AffiliateSpecificRequest $request, $id)
    {
        $specific = AffiliateSpecific::findOrFail($id);
    ...
    {
        $count = AffiliateSpecific::where('is_active', 1)->count();
