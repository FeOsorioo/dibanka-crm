...
class AffiliateManagementRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'contact_id'        => 'required|integer|exists:affiliate_contacts,id',
            'consultation_id'   => 'required|integer|exists:affiliate_consultations,id',
            'specific_id'       => 'nullable|integer|exists:affiliate_specifics,id',
