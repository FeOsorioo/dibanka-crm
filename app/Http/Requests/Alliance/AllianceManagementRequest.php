...
class AllianceManagementRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'consultation_id'   => 'required|integer|exists:alliance_consultations,id',
            'specific_id'       => 'nullable|integer|exists:alliance_specifics,id',
            'monitoring_id'     => 'nullable|integer|exists:monitoring,id',
            'type_management_id'=> 'required|integer|exists:type_management,id',
            'payroll_management_id' => 'integer|exists:payrolls,id',
    ...
    public function messages()
    {
        return [
            ...
            'payroll_management_id.exists' => 'La pagaduría seleccionada no existe',
            'payroll_management_id.integer' => 'La pagaduría debe ser un numero',
