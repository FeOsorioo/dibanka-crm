...
use App\Models\Alliance\Contact;

class AllianceContactRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'operator_entity_id' => 'integer|exists:operator_entities,id',
    ...
    public function messages()
    {
        return [
            ...
            'operator_entity_id.exists' => 'La entidad seleccionada no existe',
            'operator_entity_id.numeric' => 'La entidad debe ser un numero',
